...
def get_thermostat_readings(fritzconn: FritzConnection) -> List[Tuple[str, float]]:
    fh = FritzHomeAutomation(fritzconn)
    infos = [(x["NewDeviceName"], x["NewTemperatureCelsius"]/10) for x in fh.device_information()
